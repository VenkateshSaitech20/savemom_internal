                        ...
                        <Grid container spacing={6}>
                            ...
                            <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='name' text='District Name' />}
                                    placeholder='District Name'
                                    error={!!errors.name || apiErrors?.name}
                                    helperText={errors?.name?.message || apiErrors?.name}
                                    {...register('name', { required: registerData.districtNameReq, validate: value => value.trim() !== '' || registerData.districtNameReq })}
                                />
                            </Grid>
                            <Grid item xs={12}>
                                <Controller
