...
const AddPlan = props => {
    ...
    //     if (lastIndex >= 0) {
    //         clearErrors(`features.${lastIndex}.feature`);
    //     }
    // }, [fields, clearErrors]);
                        ...
                        <Grid container spacing={6}>
                            ...
                            {/* <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='monthly' text='Yearly Price (Monthly)' />}
                                    placeholder='monthly'
                                    error={!!errors.monthly || apiErrors?.monthly}
                                    helperText={errors?.monthly?.message || apiErrors?.monthly}
                                    {...register('monthly', { required: registerData.monthlyPriceReq, validate: value => value.trim() !== '' || registerData.monthlyPriceReq })}
                                />
                            </Grid>
                            <Grid item xs={12}>
                                <TextFieldStyled
                                    ...
                                    size={"small"}
                                    InputLabelProps={{ shrink: true }}
                                    label={<CustomInputLabel htmlFor='annually' text='Yearly Price (Annually)' />}
                                    placeholder='annually'
                                    error={!!errors.annually || apiErrors?.annually}
                                    helperText={errors?.annually?.message || apiErrors?.annually}
                                    {...register('annually', { required: registerData.monthlyPriceReq, validate: value => value.trim() !== '' || registerData.monthlyPriceReq })}
                                />
                            </Grid> */}
