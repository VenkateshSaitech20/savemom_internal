...
export async function POST(req) {
    try {
        ...
        const { name, countryId, stateId, cityId, isActive, id } = body;
        ...
        const fields = { name, countryId, stateId, cityId };
        ...
        const data = { countryId, country, stateId, state, cityId, city, isActive };
